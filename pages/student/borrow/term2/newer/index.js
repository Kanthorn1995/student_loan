...
import LoanOther101 from "./101_Forms/LoanOther101";
import MaxEducation101 from "./101_Forms/MaxEducation101";
import ParentStudent101 from "./101_Forms/ParentStudent101";
        ...
        <section className="accordion-design">
          ...
          <section className="accordion-design-content">
            <article
              ...
              data-actab-id="0"
            >
              <h4 className="accordion-design-item__label">กยศ.101</h4>
              <div className="accordion-design-item__container">
                <div className="card  mb-3">
                  <div className="card-body">
                    <StudentData101 {...props} />
                  </div>
                </div>

                <div className="card mb-3">
                  <div className="card-body">
                    <StudentAddress101 {...props} typeAddress="default" />
                  </div>
                </div>

                <div className="card mb-3">
                  <div className="card-body">
                    <StudentAddress101 {...props} typeAddress="current" />
                  </div>
                </div>

                <div className="card mb-3">
                  <div className="card-body">
                    <MaxEducation101 {...props} />
                  </div>
                </div>
                ...
                <div className="card mb-3">
                  <div className="card-body">
                    <StudentLoanHistory101 {...props} />
                  </div>
                </div>

                <div className="card mb-3">
                  <div className="card-body">
                    <ParentStudent101 {...props} typeParent="father" />
                  </div>
                </div>

                <div className="card mb-3">
                  <div className="card-body">
                    <ParentStudent101 {...props} typeParent="mother" />
                  </div>
                </div>
            ...
            <article
              ...
              data-actab-id="2"
            >
              <h4 className="accordion-design-item__label">กยศ.103</h4>
              <div className="accordion-design-item__container">
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Voluptates, deserunt minima? Ut facere minus, ipsa dolore
            ...
            <article
              ...
              data-actab-id="3"
            >
              <h4 className="accordion-design-item__label">กยศ.104</h4>
              <div className="accordion-design-item__container">
                <p>
            ...
            <article
              ...
              data-actab-id="4"
            >
              <h4 className="accordion-design-item__label">เอกสารอื่นๆ</h4>
              <div className="accordion-design-item__container">
                <p>
